...
\title{\textbf{Trabajo Pr\'actico Final \\ Reconocimiento de Figuras Utilizando Redes Neuronales }\\
...
\begin{abstract}
	El trabajo consiste en el desarrollo de una mejora de la aplicaci\'on de reconocimiento de figuras desarrollada anteriormente a partir del uso y entrenamiento de redes neuronales. Se agrega la capacidad de diferenciar entre cuadrados y rect\'angulos como as\'i tambi\'en entre circulos y elipses. Para ello se utiliza el concepto de metaconocimiento, encadenando redes con la misma estructura que se ven\'ia utilizando para en lugar de utilizar una red m\'as grande. Se agrega adem\'as el uso de un discriminate llamado elongatedness en la entrada de una de las redes.
